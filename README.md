...
Fetching origin
Fetching origin
git command on url  https://github.com/gatsbyjs/gatsby Fail!
...
- [yongzhena/sm2-stm32](https://github.com/yongzhena/sm2-stm32) - 国密算法 for 单片机stm32, 静态内存分配
...
- [ryanfleury/data_desk](https://github.com/ryanfleury/data_desk) - New version "Metadesk" at https://github.com/Dion-Systems/metadesk
...
- [asjbdkabs/physmem-Scanner](https://github.com/asjbdkabs/physmem-Scanner) - scans through physical memory and paging tables in kernel mode
...
- [surajfale/passthrough-minifilter-driver](https://github.com/surajfale/passthrough-minifilter-driver) - Windows mini-filter-driver. Blocks the access to USB drives.
...
- [Washi1337/AsmResolver](https://github.com/Washi1337/AsmResolver) - A library for editing PE files with full .NET metadata support
...
- [Sh4rk0-666/Baphomet](https://github.com/Sh4rk0-666/Baphomet) - Basic concept of how a ransomware works. Open sources ransomware
...
- [0xFenrik/Povlsomware](https://github.com/0xFenrik/Povlsomware) - Extensionless Ransomware written in C#. Fully compatible with Cobalt Strikes "Execute-Assembly" and Metasploits "Execute_dotnet_assembly". Does not spread laterally, and thus make for an excellent Ransomware Proof of Concept and/or for testing AV Vendors claim of "Ransomware Protection".
...
- [qH0sT/Ransomware-Builder-v3.0](https://github.com/qH0sT/Ransomware-Builder-v3.0) - 
...
- [EduardoPires/EquinoxProject](https://github.com/EduardoPires/EquinoxProject) - Full ASP.NET Core 5 application with DDD, CQRS and Event Sourcing concepts
...
- [Cmulator/Cmulator](https://github.com/Cmulator/Cmulator) - Cmulator is ( x86 - x64 ) Scriptable Reverse Engineering Sandbox Emulator for Shellcode and PE binaries . Based on Unicorn & Zydis Engine & quickjs
...
- [diversenok/NtUtilsLibrary](https://github.com/diversenok/NtUtilsLibrary) - Delphi library for system programming on Windows
...
- [dmdhrumilmistry/pyhtools](https://github.com/dmdhrumilmistry/pyhtools) - A collection of python written hacking tools consisting of network scanner, arp spoofer and detector, dns spoofer, code injector, packet sniffer, network jammer, email sender, downloader, wireless password harvester credential harvester, keylogger, download&execute, ransomware and reverse_backdoor.
- [vasco2016/ransomware](https://github.com/vasco2016/ransomware) - Seeing how easy it is to create ransomware.
- [CYBERDEVILZ/Cryptonite](https://github.com/CYBERDEVILZ/Cryptonite) - A ransomware created for Windows OS. It is easy to test in a safe environment before deploying it to the victims. Developed using Python
...
- [firmianay/IoT-vulhub](https://github.com/firmianay/IoT-vulhub) - IoT 固件漏洞复现环境
...
- [goffinet/packer-kvm](https://github.com/goffinet/packer-kvm) - Create VM templates with Packer for usage with Libvirt/KVM virtualization : CentOS 7, CentOS 8, CentOS 8 Stream, Alma Linux, Rocky Linux, Bionic (Ubuntu 1804), Focal (Ubuntu 2004), Debian 11 (stable), Kali Linux, Fedora 33 and Fedora 34.
...
- [arnofeng/ngx_google_deployment](https://github.com/arnofeng/ngx_google_deployment) - One-key Install Proxy for Google by Nginx
